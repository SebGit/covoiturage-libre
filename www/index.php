...
function depart(key_count){
 ...
 $(document).ready(function(){
	 ...
	 /* Pour que les drapeaux s�lectionn�s s'affichent si pr�c�dent dans navigateur */
	 ...
	 /* [FIN] Pour que les drapeaux s�lectionn�s s'affichent si pr�c�dent dans navigateur */
 ...
 function CHECK()
{
	...
	{alert('Veuillez pr�ciser au moins un lieu d\'arriv�e ou une date pour votre trajet s\'il vous pla�t');document.form1.ARRIVEE.focus();return false;}
else
