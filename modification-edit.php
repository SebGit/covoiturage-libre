...
<script type="text/javascript">
 ...
 function depart(){
	...
	if(chiffre>=3){
		$('#liste_depart').load('ajax/depart.php?COMMUNE='+ville);
		$('#liste_depart').show();
	}
	else {
		$('#liste_depart').hide();
 ...
 function arrivee(){
	...
	if(chiffre>=3){
		$('#liste_arrivee').load('ajax/arrivee.php?COMMUNE='+ville);
		$('#liste_arrivee').show();
	}
	else {
		$('#liste_arrivee').hide();
 ...
 function etape1(){
	...
	if(chiffre>=3){
		...
		$('#liste_etape1').load('ajax/etape1.php?COMMUNE='+ville);
		$('#liste_etape1').show();
	}
	else {
		$('#liste_etape1').hide();
 ...
 function etape2(){
	...
	if(chiffre>=3){
		...
		$('#liste_etape2').load('ajax/etape2.php?COMMUNE='+ville);
		$('#liste_etape2').show();
	}
	else {
		$('#liste_etape2').hide();
 ...
 function etape3(){
	...
	if(chiffre>=3){
		...
		$('#liste_etape3').load('ajax/etape3.php?COMMUNE='+ville);
		$('#liste_etape3').show();
	}
	else {
		$('#liste_etape3').hide();
...
une femme</td>
        ...
        <tr>
          <td>Votre email</td>
          <td><label for="EMAIL"><strong><?php echo $row_RStrajet['EMAIL']; ?></strong></label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td></td>
