...
<a href="#" class="pays_" id="pays_<?=$pays_desc?>">Pays : <span id="pays_<?=$pays_desc?>_nom" class="">FR</span></a>
<table id="flags_table_<?=$pays_desc?>" class="flags_table" width="auto" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td align="center" valign="middle">
		<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="BE" id="PAYS_<?=strtoupper($pays_desc)?>_1" />
		<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_1"><img src="images/flags/flag-belgique.jpg" width="20" height="13" alt="Belgique" /></label>
	</td>
	<td align="center" valign="middle">
		<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="ES" id="PAYS_<?=strtoupper($pays_desc)?>_2" />
		<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_2"><img src="images/flags/flag-espagne.jpg" width="20" height="13" alt="Espagne" /></label>
	</td>
	<td align="center" valign="middle">
		<input name="PAYS_<?=strtoupper($pays_desc)?>" type="radio" id="PAYS_<?=strtoupper($pays_desc)?>_3" value="FR" checked />
		<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_3"><img src="images/flags/flag-france.jpg" width="20" height="13" alt="France" /></label>
  ...
  <tr>
    <td align="center" valign="middle">
    	<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="IT" id="PAYS_<?=strtoupper($pays_desc)?>_4" />
    	<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_4"><img src="images/flags/flag-italie.jpg" width="20" height="13" alt="Italie" /></label>
    </td>
    <td align="center" valign="middle">
    	<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="LU" id="PAYS_<?=strtoupper($pays_desc)?>_5" />
    	<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_5"><img src="images/flags/flag-luxembourg.jpg" width="20" height="13" alt="Luxembourg" /></label>
	</td>
    <td align="center" valign="middle">
    	<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="NL" id="PAYS_<?=strtoupper($pays_desc)?>_6" />
    	<br />
<label for="PAYS_<?=strtoupper($pays_desc)?>_6"><img src="images/flags/flag-p	aysbas.jpg" width="20" height="13" alt="Pays-Bas" /></label>
    </td>
    <td align="center" valign="middle">
    	<input type="radio" name="PAYS_<?=strtoupper($pays_desc)?>" value="CH" id="PAYS_<?=strtoupper($pays_desc)?>_7" />
    	<br />
